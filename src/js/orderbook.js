...
import { BitgetSpotClient, BitgetUsdtFuturesClient } from './platforms/bitget.js';
...
} else if (platformName === "bitgetusdtfutures") {
    platformClient = new BitgetUsdtFuturesClient(params.symbol, params.depth);
}
